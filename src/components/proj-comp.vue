...
<!-- <div v-for="pro in projects" :key="pro.id" class="card text-bg-dark">
  <img :src="pro.image_url" class="card-img" :alt="pro.alt">
...
<!-- </div> --> 
<div v-for="pro in projects" :key="pro.id"  class="card">
  <span><img :src="pro.image_url" class="card-img" :alt="pro.alt"></span>
